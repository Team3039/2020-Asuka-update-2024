...
public final class Constants {
    ...
    public static final double SHOOT_NEAR_SHOT_RPM = 4000;
    public static final double SHOOT_MID_SHOT_RPM = 5750;
    public static final double SHOOT_FAR_SHOT_RPM = 3300;
    public static final double SHOOT_FAR_SHOT_RPM_FAR = 4500;
